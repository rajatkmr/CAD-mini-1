/*
This file tests single input dependence
*/
...
int main() {
	...
	a[0][0] = '-';	a[0][1] = '1';	a[0][2] = '-';	a[0][3] = '-';

	a[1][0] = '-';	a[1][1] = '0';	a[1][2] = '-';	a[1][3] = '-';

	a[2][0] = '-';	a[2][1] = '1';	a[2][2] = '-';	a[2][3] = '-';

	printf("PLA array has dependence on 1 input is %s", (single_inp_dep(a, dim1, dim2) ? "true\n": "false\n") );
	return 0;
}
