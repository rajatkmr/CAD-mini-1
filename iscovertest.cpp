...
int main() {
	...
	a[0][0] = '1';	a[0][1] = '1';	a[0][2] = '-';	a[0][3] = '0';

	a[1][0] = '-';	a[1][1] = '1';	a[1][2] = '-';	a[1][3] = '-';

	a[2][0] = '-';	a[2][1] = '1';	a[2][2] = '-';	a[2][3] = '1';

//	printf("PLA array has DC row is : %s", (rowofdc(a, dim1, dim2) ? "true\n":"false\n" ) );
	printf("PLA array is a Unate cover is : %s", (is_cover_unate(a, dim1, dim2) ? "true\n":"false\n" ) );
	return 0;
}
